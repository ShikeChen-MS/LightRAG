...
class RAGInstanceManager:
    ...
    async def _get_rag_instance_by_affinity_token(self, affinity_token: str) -> LightRAG:
        async with self._lock:
    ...
    def get_rag_instance(self, *args, **kwargs) -> LightRAG:
        loop = always_get_an_event_loop()
        return loop.run_until_complete(self._get_rag_instance(*args, **kwargs))

    def get_rag_instance_by_affinity_token(self, affinity_token: str) -> LightRAG:
        loop = always_get_an_event_loop()
        return loop.run_until_complete(self._get_rag_instance_by_affinity_token(affinity_token))
